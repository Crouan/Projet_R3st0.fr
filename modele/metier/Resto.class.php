...
class Resto {
    ...
    /** @var array() tableau d'objets Cuisine : les types de cuisine de chaque restaurant */
    private array $lesCuisines;
    ...
    public function getLesCuisines(): array {
        return $this->lesCuisines;
    }

    public function setLesCuisines(array $lesCuisines): void {
        $this->lesCuisines = $lesCuisines;
    }
